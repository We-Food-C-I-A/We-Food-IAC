...
resource "aws_vpc" "vpc" {
  ...
  tags = {
    Name = "${var.region_name}-${var.terraform_name}-vpc"
  }
}
...
resource "aws_internet_gateway" "igw" {
  ...
  tags = {
    Name = "${var.region_name}-${var.terraform_name}-igw"
  }
}
...
resource "aws_subnet" "net" {
  ...
  tags = {
    Name = "${var.region_name}-${var.terraform_name}-net-public"
  }
}
...
resource "aws_subnet" "app" {
  ...
  tags = {
    Name = "${var.region_name}-${var.terraform_name}-app-private"
  }
}
...
resource "aws_security_group" "bastion_sg" {
  ...
  tags = {
    Name = "${var.region_name}-${var.terraform_name}-bastion-sg"
  }
}
